...
class CampaignShow extends Component {
	...
	static async getInitialProps(props) {
        //actual address of the campaign in the url
		const campaign = Campaign(props.query.address);
		const summary = await campaign.methods.getSummary().call();
		//Returns Result object as
		/*
			Result {
				'0' : '100',
				'1' : '0',
	...
	renderCards() {
		...
		const items = [
			...
			},
			{
				...
				description: 'You must contribute at least this much amount of wei'
			},
			{
				header: requestCount,
			...
			},
			{
				...
				description: 'Amout of money this campaign left to spend'
			}
		];
